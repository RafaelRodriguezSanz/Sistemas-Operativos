 ...
 * 
 * Please see the {@link com.ucudal.tarea1.OS} to see the commands that use this
 * class
 * 
...
public final class CommandExecutor {
    ...
    public void addCommand(String command) {
        if (processBuilder.command().size() == 0) {
            processBuilder.command(new String[] { "/bin/bash", "-c", "echo " + CommandExecutor.password
                    + "| sudo -S -u " + CommandExecutor.username + " -s " + command });
        } else {
